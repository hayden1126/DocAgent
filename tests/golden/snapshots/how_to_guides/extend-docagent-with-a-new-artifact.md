---
title: "Extend docagent with a new artifact"
slug: extend-docagent-with-a-new-artifact
...
- [tinylib.cli](../reference/tinylib.cli.md)
- [run-docagent-in-ci](./run-docagent-in-ci.md)
